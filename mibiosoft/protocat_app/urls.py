...
urlpatterns = [
    ...
    url(r'^protocol_list_sort/(?P<type>[\w]+)/$', views.protocol_list_sort, name='protocol_list_sorted'),
    url(r'^protocol_search_sort/(?P<type>[\w]+)/(?P<terms>[\w|\W]+)/$', views.protocol_search_sort, name='protocol_search_sort'),
